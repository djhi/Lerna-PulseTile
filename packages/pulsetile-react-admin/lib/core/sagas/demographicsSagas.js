...
var responseInfo = {};
exports.default = effects_1.takeEvery(demographicsAction_1.DEMOGRAPHICS_ACTION.REQUEST, function (action) {
    var url, options, result, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = token_1.domainName + '/api/demographics/' + localStorage.getItem('patientId');
                options = {};
                options.method = "GET";
                if (!options.headers) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.put(demographicsAction_1.demographicsAction.success(result))];
            case 3:
                _a.sent();
                return [3 /*break*/, 6];
            ...
            case 7:
                e_1 = _a.sent();
                return [4 /*yield*/, effects_1.put(demographicsAction_1.demographicsAction.error(e_1))];
            case 8:
                _a.sent();
                return [3 /*break*/, 9];
