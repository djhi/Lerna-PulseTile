...
var responseInfo = {};
exports.default = effects_1.takeEvery(patientsCountAction_1.PATIENTS_COUNT_ACTION.REQUEST, function (action) {
    var patientId, url, options, result, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                patientId = get_1.default(action, 'data', null);
                url = token_1.domainName + '/api/patients/' + patientId + '/counts';
                options = {};
                options.method = "GET";
                if (!options.headers) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.put(patientsCountAction_1.patientsCountAction.success(result))];
            case 3:
                _a.sent();
                return [3 /*break*/, 6];
            ...
            case 7:
                e_1 = _a.sent();
                return [4 /*yield*/, effects_1.put(patientsCountAction_1.patientsCountAction.error(e_1))];
            case 8:
                _a.sent();
                return [3 /*break*/, 9];
