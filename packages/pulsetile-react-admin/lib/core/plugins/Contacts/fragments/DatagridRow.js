...
var ContactsDatagridRow = function (props) {
    ...
    return (react_1.default.createElement(CustomDatagridRow_1.default, __assign({}, props),
        ...
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-relationship" }, record.relationship),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-nextOfKin" }, record.nextOfKin ? 'Yes' : 'No'),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-source" }, record.source)));
};
exports.default = ContactsDatagridRow;
