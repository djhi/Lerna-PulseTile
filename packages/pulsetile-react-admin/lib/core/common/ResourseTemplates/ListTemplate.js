...
var TableHeader_1 = __importDefault(require("../../common/TableHeader"));
var CustomIcon_1 = __importDefault(require("../../common/CustomIcon"));
var DetailsTemplate_1 = __importDefault(require("./DetailsTemplate"));
var constants_1 = require("./fragments/constants");
var TableContent_1 = __importDefault(require("./fragments/TableContent"));
var ChartContent_1 = __importDefault(require("./fragments/ChartContent"));
var TimelineContent_1 = __importDefault(require("./fragments/TimelineContent"));
var ListModePopover_1 = __importDefault(require("./popovers/ListModePopover"));
var ColumnsTogglingIcon_1 = __importDefault(require("./icons/ColumnsTogglingIcon"));
...
var ListTemplate = /** @class */ (function (_super) {
    ...
    ListTemplate.prototype.componentDidMount = function () {
        ...
        if (isChartDefault) {
            this.setState({
                listMode: constants_1.MODE_CHART,
            });
        }
    ...
    ListTemplate.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classes.container },
            ...
            react_1.default.createElement(TableHeader_1.default, { resource: resourceUrl }),
            react_1.default.createElement(Grid_1.default, { container: true, spacing: 16, className: classes.mainBlock },
                isListOpened &&
                    react_1.default.createElement(Grid_1.default, { className: classes.list, item: true, xs: 12, sm: this.isListPage() ? 12 : 6 },
                        react_1.default.createElement("div", { className: classes.headerBlock },
                            react_1.default.createElement("div", { className: classes.blockTitle },
                                react_1.default.createElement(Typography_1.default, { className: classes.title }, titleTable),
                                react_1.default.createElement("div", { className: classes.emptyBlock }),
                                !this.isListPage() &&
                                    react_1.default.createElement(Tooltip_1.default, { title: "Expand" },
                                        react_1.default.createElement(IconButton_1.default, { onClick: function () { return history.push("/" + resourceUrl); } },
                                ...
                                (hasChart || hasTimetable) &&
                                    react_1.default.createElement(react_1.default.Fragment, null,
                                        react_1.default.createElement(Tooltip_1.default, { title: "Table" },
                                            react_1.default.createElement(IconButton_1.default, { onClick: function (e) { return _this.popoverOpen(e); } },
                                ...
                                !headerFilterAbsent &&
                                    react_1.default.createElement(Tooltip_1.default, { title: "Search" },
                                        react_1.default.createElement(IconButton_1.default, { onClick: function () { return _this.toggleFilter(); } },
                            ...
                            isFilterOpened &&
                                react_1.default.createElement("div", { className: classes.filterBlock },
                                    react_1.default.createElement(Paper_1.default, { className: classes.filterInput, elevation: 1 },
                                        react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faFilter, className: classes.filterInputIcon, size: "1x" }),
                        ...
                        react_1.default.createElement(ContentBlock, __assign({ key: key, filterText: filterText, hiddenColumns: hiddenColumns, createUrl: createUrl, idsNumber: idsNumber, isCustomDatagrid: isCustomDatagrid, history: history, notCreate: notCreate }, this.props))),
                (!this.isCreatePage())
                    ?
...
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(styles_1.withStyles(listStyles)(ListTemplate));
