...
var EditFormToolbar_1 = __importDefault(require("../../common/Toolbars/EditFormToolbar"));
...
var EditTemplate = function (_a) {
    ...
    return (react_1.default.createElement(Grid_1.default, { item: true, xs: 12, sm: isListOpened ? 6 : 12 },
        ...
        !isCustom
            ?
                react_1.default.createElement(react_admin_1.Edit, __assign({ undoable: false }, rest),
                    react_1.default.createElement(react_admin_1.SimpleForm, { className: classes.editForm, toolbar: react_1.default.createElement(EditFormToolbar_1.default, { changeViewType: changeViewType }) }, children))
            :
                react_1.default.createElement("div", { className: classes.customFormBlock }, children)));
};
exports.default = styles_1.withStyles(styles)(EditTemplate);
