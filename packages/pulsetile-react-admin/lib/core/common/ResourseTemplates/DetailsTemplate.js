...
var DetailsTemplate = /** @class */ (function (_super) {
    ...
    DetailsTemplate.prototype.render = function () {
        ...
        if (viewType === 'show') {
            return (react_1.default.createElement(ShowTemplate, __assign({ changeViewType: this.changeViewType }, this.props)));
        }
        else if (viewType === 'edit') {
            return (react_1.default.createElement(EditTemplate, __assign({ changeViewType: this.changeViewType }, this.props)));
        }
        return null;
    };
    return DetailsTemplate;
}(react_1.Component));
exports.default = DetailsTemplate;
