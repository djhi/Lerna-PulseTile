...
var DiagnosisByAge = /** @class */ (function (_super) {
    ...
    function DiagnosisByAge() {
        ...
        _this.isAreaVisible = function (item) {
    ...
    DiagnosisByAge.prototype.render = function () {
        var _this = this;
        var _a = this.props, classes = _a.classes, diagnosisByAge = _a.diagnosisByAge, isDiagnosisVisible = _a.isDiagnosisVisible, isAgeRangeVisible = _a.isAgeRangeVisible;
        var linesArray = [
        ...
        return (react_1.default.createElement("div", { className: classes.mainBlock },
            react_1.default.createElement(index_2.default, { variant: "body1", className: classes.chartTitle }, "Diagnosis By Age"),
            react_1.default.createElement("div", { className: classes.chartBlock },
                react_1.default.createElement(recharts_1.ResponsiveContainer, { height: 300 },
                    react_1.default.createElement(recharts_1.AreaChart, { data: dummyDataFilter, margin: { top: 10, right: 30, left: 0, bottom: 0 } },
                        ...
                        linesArray.map(function (item, key) {
                            if (_this.isAreaVisible(item.dataKey)) {
                                return (react_1.default.createElement(recharts_1.Area, { key: key, type: "linear", dataKey: item.dataKey, stackId: "1", stroke: item.color, fill: item.color }));
                            }
                        }),
