...
var CurrentSectionBlock = function (_a) {
    ...
    return (react_1.default.createElement(Grid_1.default, { item: true, xs: 12, sm: currentRow ? 6 : 12 },
        react_1.default.createElement(SectionBlock, { currentRow: currentRow, title: currentSection.section, classes: classes, onRowClick: onRowClick, sectionsInfo: sectionsInfo, latestVersionInfo: latestVersionInfo, toggleMode: toggleMode, isVersionInfo: isVersionInfo })));
};
exports.default = styles_1.withStyles(styles)(CurrentSectionBlock);
