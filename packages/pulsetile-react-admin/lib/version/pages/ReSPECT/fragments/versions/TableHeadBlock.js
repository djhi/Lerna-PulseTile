...
var TableHeadBlock = /** @class */ (function (_super) {
    ...
    TableHeadBlock.prototype.render = function () {
        return (react_1.default.createElement(TableHead_1.default, null,
            react_1.default.createElement(TableRow_1.default, null, rows.map(function (row) { return (react_1.default.createElement(TableCell_1.default, { key: row.id, align: row.numeric ? 'right' : 'left', padding: row.disablePadding ? 'none' : 'default' }, row.label)); }, this))));
    };
