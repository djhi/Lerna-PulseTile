 ...
 * @param {shape} rest
 */
var PersonalNotesCreate = function (_a) {
    var classes = _a.classes, rest = __rest(_a, ["classes"]);
    return (react_1.default.createElement(CreateTemplate_1.default, __assign({ blockTitle: "Personal Note" }, rest),
        react_1.default.createElement(Inputs_1.default, null)));
};
exports.default = PersonalNotesCreate;
