 ...
 * @param {shape} rest
 */
var TopThreeThingsEdit = function (_a) {
    var classes = _a.classes, rest = __rest(_a, ["classes"]);
    return (react_1.default.createElement(EditTemplate_1.default, __assign({ blockTitle: "Top Three Things" }, rest),
        react_1.default.createElement(Inputs_1.default, null)));
};
exports.default = TopThreeThingsEdit;
