...
var TopThreeThingsDatagridRow = function (props) {
    ...
    return (react_1.default.createElement(CustomDatagridRow_1.default, __assign({}, props),
        ...
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-name1" }, record.name1),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-name2" }, record.name2),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-name3" }, record.name3),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-source" }, record.source)));
};
exports.default = TopThreeThingsDatagridRow;
