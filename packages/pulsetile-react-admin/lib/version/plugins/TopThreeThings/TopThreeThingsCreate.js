 ...
 * @param {shape} rest
 */
var TopThreeThingsCreate = function (_a) {
    var classes = _a.classes, rest = __rest(_a, ["classes"]);
    return (react_1.default.createElement(CreateTemplate_1.default, __assign({ blockTitle: "Top Three Things" }, rest),
        react_1.default.createElement(Inputs_1.default, null)));
};
exports.default = TopThreeThingsCreate;
