 ...
 */
var VitalsShow = function (_a) {
    var classes = _a.classes, rest = __rest(_a, ["classes"]);
    return (react_1.default.createElement(ShowTemplate_1.default, __assign({ pageTitle: "Vitals" }, rest),
        react_1.default.createElement(Form_1.default, __assign({ isDetailsPage: true }, rest))));
};
exports.default = VitalsShow;
