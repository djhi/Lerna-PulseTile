 ...
 * @constructor
 */
var TransferOfCareEdit = function (_a) {
    var classes = _a.classes, rest = __rest(_a, ["classes"]);
    return (react_1.default.createElement(EditTemplate_1.default, __assign({ isCustom: true, blockTitle: "Transfer Of Care" }, rest),
        react_1.default.createElement(Form_1.default, null)));
};
exports.default = TransferOfCareEdit;
