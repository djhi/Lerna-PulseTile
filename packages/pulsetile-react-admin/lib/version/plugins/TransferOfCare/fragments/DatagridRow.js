...
var TransferOfCareDatagridRow = function (props) {
    ...
    return (react_1.default.createElement(CustomDatagridRow_1.default, __assign({}, props),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-from" }, record.from),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-to" }, record.to),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-transferDateTime" }, moment_1.default(record.transferDateTime).format(constants_1.DATE_FORMAT)),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-source" }, record.source)));
};
exports.default = TransferOfCareDatagridRow;
