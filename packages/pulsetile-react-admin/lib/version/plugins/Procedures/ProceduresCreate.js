 ...
 * @param {shape} props
 */
var ProceduresCreate = function (props) { return (react_1.default.createElement(CreateTemplate_1.default, __assign({ isCustom: true, blockTitle: "Procedure" }, props),
    react_1.default.createElement(Form_1.default, __assign({ isCreate: true }, props)))); };
exports.default = ProceduresCreate;
