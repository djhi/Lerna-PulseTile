...
var ProceduresDatagridRow = function (props) {
    ...
    return (react_1.default.createElement(CustomDatagridRow_1.default, __assign({}, props),
        ...
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-date" }, moment_1.default(record.date).format(constants_1.DATE_FORMAT)),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-time" }, moment_1.default(record.time).format('HH:mm')),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-source" }, record.source)));
};
exports.default = ProceduresDatagridRow;
