 ...
 * @constructor
 */
var ProceduresEdit = function (props) { return (react_1.default.createElement(EditTemplate_1.default, __assign({ isCustom: true, blockTitle: "Procedure" }, props),
    react_1.default.createElement(Form_1.default, __assign({}, props)))); };
exports.default = ProceduresEdit;
