...
var ResultsDatagridRow = function (props) {
    var record = props.record;
    if (!record) {
        return null;
    }
    return (react_1.default.createElement(CustomDatagridRow_1.default, __assign({}, props),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-testName" }, record.testName),
        react_1.default.createElement(TableCell_1.default, { key: record.id + "-sampleTaken" }, moment_1.default(record.sampleTaken).format(constants_1.DATE_FORMAT)),
...
exports.default = ResultsDatagridRow;
