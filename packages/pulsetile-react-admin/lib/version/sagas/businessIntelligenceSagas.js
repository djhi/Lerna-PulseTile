...
exports.default = effects_1.takeEvery(businessIntelligenceAction_1.BUSINESS_INTELLIGENCE_ACTION.REQUEST, function (action) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            // }
            return [4 /*yield*/, effects_1.put(businessIntelligenceAction_1.businessIntelligenceAction.success())];
            case 1:
                // const url = domainName + '/BI-data';
                // let options = {};
                // options.method = 'GET';
