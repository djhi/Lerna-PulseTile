...
var ProceduresDatagridRow = function (props) {
    ...
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        ...
        React.createElement(TableCell, { key: record.id + "-date" }, moment(record.date).format(DATE_FORMAT)),
        React.createElement(TableCell, { key: record.id + "-time" }, moment(record.time).format('HH:mm')),
