...
var ShowTemplate = /** @class */ (function (_super) {
    ...
    ShowTemplate.prototype.render = function () {
        ...
        var currentItem = get(labresults, id, null);
        var resultsArray = get(currentItem, 'testResults', []);
        ...
        return (React.createElement(Grid, { item: true, xs: 12, sm: isListOpened ? 6 : 12 },
            React.createElement(ExpansionPanel, { className: isMainPanelOpen ? classes.currentExpansionPanel : classes.expansionPanel, expanded: isMainPanelOpen, onChange: function () { return _this.toggleMainPanel(); } },
                ...
                isMainPanelOpen &&
                    React.createElement(ExpansionPanelDetails, { className: classes.expansionPanelDetails },
                        React.createElement(Show, __assign({ className: classes.showDetails, title: pageTitle }, this.props),
            ...
            React.createElement(ExpansionPanel, { className: isSystemInfoPanelOpen ? classes.currentExpansionPanel : classes.expansionPanel, expanded: isSystemInfoPanelOpen, onChange: function () { return _this.toggleSystemInfoPanel(); } },
                React.createElement(ExpansionPanelSummary, { className: classes.expansionPanelSummary, expandIcon: React.createElement(ExpandMoreIcon, { className: classes.expandIcon }) },
                    React.createElement(Typography, { className: classes.expansionTypography },
                        "Results (",
                        resultsNumber,
                        ")")),
                React.createElement(ExpansionPanelDetails, { className: classes.expansionPanelDetails }, (resultsArray.length > 0) && resultsArray.map(function (item, key) {
                    return (React.createElement("div", { className: classes.resultBlock, key: key },
                        React.createElement(FormControl, { className: classes.formControl },
                            React.createElement(FormLabel, { className: classes.formLabel }, "Results"),
                            React.createElement(Typography, { className: classes.formValue }, item.result)),
                        React.createElement(FormControl, { className: classes.formControl },
                            React.createElement(FormLabel, { className: classes.formLabel }, "Value"),
                            React.createElement(Typography, { className: classes.formValue }, item.value)),
                        React.createElement(FormControl, { className: classes.formControl },
                            React.createElement(FormLabel, { className: classes.formLabel }, "Units"),
                            React.createElement(Typography, { className: classes.formValue }, item.unit)),
                        React.createElement(FormControl, { className: classes.formControl },
                            React.createElement(FormLabel, { className: classes.formLabel }, "Normal range"),
                            React.createElement(Typography, { className: classes.formValue }, item.normalRange)),
                        React.createElement(FormControl, { className: classes.formControl },
                            React.createElement(FormLabel, { className: classes.formLabel }, "Comment"),
                            React.createElement(Typography, { className: classes.formValue }, item.comment)),
