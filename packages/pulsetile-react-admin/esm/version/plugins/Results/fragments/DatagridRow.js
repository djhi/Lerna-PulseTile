...
var ResultsDatagridRow = function (props) {
    ...
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        React.createElement(TableCell, { key: record.id + "-testName" }, record.testName),
        React.createElement(TableCell, { key: record.id + "-sampleTaken" }, moment(record.sampleTaken).format(DATE_FORMAT)),
