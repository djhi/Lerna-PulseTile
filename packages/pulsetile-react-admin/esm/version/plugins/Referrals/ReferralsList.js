...
var ReferralsList = function (_a) {
    ...
    return (React.createElement(ListTemplate, __assign({ create: ReferralsCreate, edit: ReferralsEdit, show: ReferralsShow, resourceUrl: "referrals", title: "Referrals", CustomRow: DatagridRow, isCustomDatagrid: true }, rest),
        React.createElement(DateField, { label: "Date of Referral", source: "dateOfReferral" }),
        React.createElement(TextField, { label: "Referral From", source: "referralFrom" }),
        React.createElement(TextField, { label: "Referral To", source: "referralTo" }),
