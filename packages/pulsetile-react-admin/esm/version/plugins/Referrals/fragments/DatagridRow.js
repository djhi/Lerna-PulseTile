...
var ReferralsDatagridRow = function (props) {
    ...
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        React.createElement(TableCell, { key: record.id + "-dateOfReferral" }, moment(record.dateOfReferral).format(DATE_FORMAT)),
        React.createElement(TableCell, { key: record.id + "-referralFrom" }, record.referralFrom),
        React.createElement(TableCell, { key: record.id + "-referralTo" }, record.referralTo),
