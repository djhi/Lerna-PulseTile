...
var PersonalNotesList = function (_a) {
    ...
    return (React.createElement(ListTemplate, __assign({ create: PersonalNotesCreate, edit: PersonalNotesEdit, show: PersonalNotesShow, resourceUrl: "personalnotes", title: "Personal Notes", CustomRow: DatagridRow, isCustomDatagrid: true }, rest),
        React.createElement(TextField, { label: "Type", source: "noteType" }),
