...
var PersonalNotesShow = function (_a) {
    ...
    return (React.createElement(ShowTemplate, __assign({ pageTitle: "Personal Note" }, rest),
        React.createElement(TextField, { className: classes.labelBlock, source: "noteType", label: "Type" }),
        React.createElement(TextField, { className: classes.labelBlock, source: "notes", label: "Note" }),
