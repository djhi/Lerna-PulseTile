...
var PersonalNotesShow = function (_a) {
    ...
    return (React.createElement(ShowTemplate, __assign({ pageTitle: "Clinical Note" }, rest),
        React.createElement(TextField, { className: classes.labelBlock, source: "clinicalNotesType", label: "Type" }),
        React.createElement(TextField, { className: classes.labelBlock, source: "note", label: "Note" }),
