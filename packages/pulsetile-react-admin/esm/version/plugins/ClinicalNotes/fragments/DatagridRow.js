...
var ClinicalNotesDatagridRow = function (props) {
    var record = props.record;
    if (!record) {
        return null;
    }
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        React.createElement(TableCell, { key: record.id + "-clinicalNotesType" }, record.clinicalNotesType),
        React.createElement(TableCell, { key: record.id + "-author" }, record.author),
