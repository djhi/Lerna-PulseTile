...
var VaccinationsList = function (_a) {
    ...
    return (React.createElement(ListTemplate, __assign({ create: VaccinationsCreate, edit: VaccinationsEdit, show: VaccinationsShow, resourceUrl: "vaccinations", title: "Vaccinations", CustomRow: DatagridRow, isCustomDatagrid: true }, rest),
        React.createElement(TextField, { label: "Vaccination Name", source: "vaccinationName" }),
        React.createElement(DateField, { label: "Date and Time", source: "dateCreated" }),
