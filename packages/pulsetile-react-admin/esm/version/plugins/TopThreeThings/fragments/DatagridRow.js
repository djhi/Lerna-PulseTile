...
var TopThreeThingsDatagridRow = function (props) {
    ...
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        ...
        React.createElement(TableCell, { key: record.id + "-name1" }, record.name1),
        React.createElement(TableCell, { key: record.id + "-name2" }, record.name2),
        React.createElement(TableCell, { key: record.id + "-name3" }, record.name3),
