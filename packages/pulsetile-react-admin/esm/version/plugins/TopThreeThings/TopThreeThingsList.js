...
var TopThreeThingsList = function (_a) {
    ...
    return (React.createElement(ListTemplate, __assign({ create: TopThreeThingsCreate, edit: TopThreeThingsEdit, show: TopThreeThingsShow, resourceUrl: "top3Things", title: "Top Three Things", CustomRow: DatagridRow, isCustomDatagrid: true }, rest),
        React.createElement(DateField, { source: "dateCreated", label: "Date created" }),
        React.createElement(TextField, { source: "name1", label: "Issue #1" }),
        React.createElement(TextField, { source: "name2", label: "Issue #2" }),
        React.createElement(TextField, { source: "name3", label: "Issue #3" }),
