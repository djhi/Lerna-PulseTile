    ...
    TableHeadBlock.prototype.render = function () {
        return (React.createElement(TableHead, null,
            React.createElement(TableRow, null,
                rows.map(function (row) { return (React.createElement(TableCell, { key: row.id, align: row.numeric ? 'right' : 'left', padding: row.disablePadding ? 'none' : 'default' }, row.label)); }, this),
