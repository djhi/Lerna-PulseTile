...
var DiagnosisByAge = /** @class */ (function (_super) {
    ...
    DiagnosisByAge.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes.mainBlock },
            React.createElement(Typography, { variant: "body1", className: classes.chartTitle }, "Diagnosis By Age"),
            React.createElement("div", { className: classes.chartBlock },
                React.createElement(ResponsiveContainer, { height: 300 },
                    React.createElement(AreaChart, { data: dummyDataFilter, margin: { top: 10, right: 30, left: 0, bottom: 0 } },
                        ...
                        linesArray.map(function (item, key) {
                            if (_this.isAreaVisible(item.dataKey)) {
                                return (React.createElement(Area, { key: key, type: "linear", dataKey: item.dataKey, stackId: "1", stroke: item.color, fill: item.color }));
                            }
                        }),
