...
var MenuButton = function (_a) {
    ...
    return (React.createElement("div", { className: classes.menuButtonBlock },
        React.createElement(Button, { "aria-label": !isSidebarOpen ? 'Menu' : 'Close', variant: "contained", color: "primary", className: classes.menuButton, onClick: function () { return setSidebarVisibility(!isSidebarOpen); } },
            !isSidebarOpen ? React.createElement(MenuIcon, null) : React.createElement(CloseIcon, null),
...
var LowPart = /** @class */ (function (_super) {
    ...
    LowPart.prototype.render = function () {
        ...
        return (React.createElement(Toolbar, { className: classes.lowPart },
            isPageHasTitle &&
                React.createElement(PageTitle, { classes: classes, location: location }),
            React.createElement("div", { className: classes.menuAndBanner },
                React.createElement(MenuButton, { classes: classes, setSidebarVisibility: setSidebarVisibility, isSidebarOpen: isSidebarOpen }),
                !isPageHasPatientBanner &&
                    React.createElement(PatientBanner, { location: location, classes: classes, patientInfo: patientInfo })),
            React.createElement(MobileMenu, { isPageHasPatientBanner: isPageHasPatientBanner, setSidebarVisibility: setSidebarVisibility, isSidebarOpen: isSidebarOpen, patientInfo: patientInfo })));
    };
    return LowPart;
}(Component));
;
