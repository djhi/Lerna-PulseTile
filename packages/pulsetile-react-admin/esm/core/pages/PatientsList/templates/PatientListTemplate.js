...
var ListTemplate = /** @class */ (function (_super) {
    ...
    function ListTemplate() {
        ...
        _this.getTitleForClinicalSearh = function (userClinicalQuery) {
            ...
            var searchType = get(userClinicalQuery, 'searchType', null);
            var searchValue = get(userClinicalQuery, 'searchValue', null);
            var gender = get(userClinicalQuery, 'gender', null);
            var birthDate = get(userClinicalQuery, 'birthDate', null);
            var maxAge = get(userClinicalQuery, 'maxAge', null);
            var minAge = get(userClinicalQuery, 'minAge', null);
            ...
            React.createElement(Grid, { container: true, spacing: 16, className: classes.mainBlock },
                isListOpened &&
                    React.createElement(Grid, { className: classes.list, item: true, xs: 12, sm: this.isListPage() ? 12 : 6 },
                        ...
                        React.createElement(ContentBlock, __assign({ key: key, filterText: filterText, hiddenColumns: hiddenColumns, createUrl: createUrl, idsNumber: idsNumber, isCustomDatagrid: isCustomDatagrid, history: history }, this.props))),
                (!this.isCreatePage())
                    ?
