...
import { AUTH_LOGOUT, AUTH_ERROR, AUTH_CHECK } from 'react-admin';
...
var FetchLogin = function (resolve, reject) {
    fetch(url, options)
        ...
        if (get(response, 'status', null) !== 'loading_data') {
            ...
            var userName = get(decodeToken, 'openid.firstName', null) + ' ' + get(decodeToken, 'openid.lastName', null);
            var role = ('phrUser' === get(decodeToken, 'openid.role', null)) ? 'PHR' : 'IDCR';
...
export default (function (type, params) { return __awaiter(_this, void 0, void 0, function () {
    var urlLogout;
    return __generator(this, function (_a) {
        if (type === AUTH_LOGOUT) {
            if (localStorage.getItem('userId') && token) {
                urlLogout = domainName + '/api/logout';
