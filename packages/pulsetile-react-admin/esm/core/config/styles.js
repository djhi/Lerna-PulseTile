...
function getBackground(isContrastMode, themeColor, imageName) {
    var cardBackgroundImage = get(themeImages, imageName, null);
...
function getCurrentTheme(isContrastMode) {
    var backgroundImage = isContrastMode ? null : get(themeImages, 'backgroundImage', null);
    var palette = getCurrentPalette(isContrastMode);
    var isOldDesign = get(window, 'config.isOldDesign', false);
    var isRectangleButtons = get(window, 'config.isRectangleButtons', false);
