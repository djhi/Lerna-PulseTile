...
var AllergiesShow = function (_a) {
    ...
    return (React.createElement(ShowTemplate, __assign({ pageTitle: "Allergy" }, rest),
        React.createElement(TextField, { className: classes.labelBlock, label: "Cause", source: "cause" }),
        React.createElement(TextField, { className: classes.labelBlock, label: "Reaction / Description", source: "reaction" }),
