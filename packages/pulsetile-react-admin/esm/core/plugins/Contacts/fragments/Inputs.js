...
var ContactsInputs = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(FormGroup, { className: classes.formGroup },
            React.createElement(SelectInput, { source: "relationship", label: "Relationship", choices: relationshipArray, fullWidth: true, InputProps: { disableUnderline: true, classes: { root: classes.customRoot, input: classes.customSelector } }, InputLabelProps: { shrink: true, className: classes.customFormLabel } })),
        React.createElement(FormGroup, { className: classes.formGroup },
            React.createElement(SelectInput, { source: "relationshipCode", label: "Relationship Type", choices: relationshipTypeArray, fullWidth: true, InputProps: { disableUnderline: true, classes: { root: classes.customRoot, input: classes.customSelector } }, InputLabelProps: { shrink: true, className: classes.customFormLabel } })),
        React.createElement(FormGroup, { className: classes.formGroup },
            React.createElement(TextInput, { source: "relationshipTerminology", label: "Relationship Terminology", fullWidth: true, InputProps: { disableUnderline: true, classes: { root: classes.customRoot, input: classes.customInput } }, InputLabelProps: { shrink: true, className: classes.customFormLabel } })),
        React.createElement(FormGroup, { className: classes.formGroup },
            React.createElement(BooleanInput, { label: "Next of Kin", source: "nextOfKin", fullWidth: true })),
        React.createElement(FormGroup, { className: classes.formGroup },
            React.createElement(LongTextInput, { source: "contactInformation", label: "Contact Information", rows: 20, fullWidth: true, InputProps: { disableUnderline: true, classes: { root: classes.customRoot, input: classes.customTextarea } }, InputLabelProps: { shrink: true, className: classes.customFormLabel } })),
        React.createElement(FormGroup, { className: classes.formGroup },
