...
var ProblemsDatagridRow = function (props) {
    ...
    return (React.createElement(CustomDatagridRow, __assign({}, props),
        React.createElement(TableCell, { key: record.id + "-problem" }, record.problem),
        React.createElement(TableCell, { key: record.id + "-dateOfOnset" }, moment(record.dateOfOnset).format(DATE_FORMAT)),
