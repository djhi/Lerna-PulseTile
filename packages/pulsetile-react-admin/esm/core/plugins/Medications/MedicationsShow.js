...
var ProblemsShow = function (_a) {
    ...
    return (React.createElement(ShowTemplate, __assign({ pageTitle: "Medication" }, rest),
        React.createElement(TextField, { className: classes.labelBlock, label: "Name", source: "name" }),
        React.createElement(TextField, { className: classes.labelBlock, label: "Dose Description", source: "doseAmount" }),
