        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, fetch(url, options).then(function (res) { return res.json(); })
                        ...
                        var redirectUrl = get(response, 'redirectURL', null);
                        if (redirectUrl) {
            ...
            case 2:
                result = _a.sent();
                return [4 /*yield*/, put(initializeAction.success(result))];
            case 3:
                _a.sent();
                return [3 /*break*/, 6];
            case 4:
                e_1 = _a.sent();
                return [4 /*yield*/, put(initializeAction.error(e_1))];
            case 5:
                _a.sent();
                return [3 /*break*/, 6];
