...
export default takeEvery(PATIENTS_COUNT_ACTION.REQUEST, function (action) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                patientId = get(action, 'data', null);
                url = domainName + '/api/patients/' + patientId + '/counts';
                options = {};
                options.method = "GET";
                if (!options.headers) {
            ...
            case 2:
                ...
                return [4 /*yield*/, put(patientsCountAction.success(result))];
            case 3:
                _a.sent();
                return [3 /*break*/, 6];
            ...
            case 7:
                e_1 = _a.sent();
                return [4 /*yield*/, put(patientsCountAction.error(e_1))];
            case 8:
                _a.sent();
                return [3 /*break*/, 9];
