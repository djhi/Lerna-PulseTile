...
export default takeEvery(EMERGENCY_SUMMARY_ACTION.REQUEST, function (action) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                resource = get(action, 'resource', null);
                patientId = get(action, 'patientId', null);
                url = domainName + '/api/patients/' + patientId + '/' + resource;
                options = {};
                options.method = 'GET';
                if (!options.headers) {
            ...
            case 2:
                result = _a.sent();
                return [4 /*yield*/, put(emergencySummaryAction.success({
                        data: result,
                        resource: resource,
                    }))];
            case 3:
            ...
            case 4:
                e_1 = _a.sent();
                return [4 /*yield*/, put(emergencySummaryAction.error(e_1))];
            case 5:
                _a.sent();
                return [3 /*break*/, 6];
