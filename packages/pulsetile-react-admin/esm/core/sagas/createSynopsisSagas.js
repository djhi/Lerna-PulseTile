...
export default function createCustomSagas(actionName, actionType, pluginName) {
    return takeEvery(actionName.REQUEST, function (action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = domainName + '/api/patients/' + localStorage.getItem('patientId') + '/synopsis/' + pluginName;
                    options = {};
                    options.method = "GET";
                    if (!options.headers) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, put(actionType.success(result))];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                ...
                case 7:
                    e_1 = _a.sent();
                    return [4 /*yield*/, put(actionType.error(e_1))];
                case 8:
                    _a.sent();
                    return [3 /*break*/, 9];
